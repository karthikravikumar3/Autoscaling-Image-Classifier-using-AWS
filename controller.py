...
while True:
    try:
        ...
        if total_msg > current_count*1 and current_count < max_count:
            print('Scaling Out...')
        ...
        elif total_msg < (current_count-1)*1 and current_count > min_count:
            print('Scaling In...')
